...
class Nav {
  ...
  display() {
    ...
    if (expPosn >= this.navHeight) { scrollTarget = expNav } 
    else if (expPosn < this.navHeight && eduPosn >= this.navHeight) { scrollTarget = eduNav } 
    else if (eduPosn < this.navHeight && porPosn >= this.navHeight) { scrollTarget = porNav } 
    else if (porPosn < this.navHeight && refPosn >= this.navHeight) { scrollTarget = refNav }
...
export class PortfolioScrollService {
  ...
  display_btn_ctnSwitch() { this.btn_ctnSwitch.displayWhenScroll(100) }
  display_btn_goTop() { this.btn_goTop.displayWhenScroll(20) }
  display_nav_indicator() { this.nav.display() }
